...
* Usage
  ...
  we have is a some data structures, an interpreter, and the scaffolding of a
  repl. You can look at `xprl.core/loadfile` for an example of how it works.
* Docs
