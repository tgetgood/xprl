...
** Types
   ...
   formalise programs, but the dependence on logic is historical and often a
   useless yak shave.
...
** SI is Mostly Irrelevant when Programming
...
* The Language as it Stands
  - Note taken on [2025-07-20 Sun 09:40] \\
    This whole section should be edited for currency and moved into language.org.
...
** Message Passing and Metaprogramming                          :reflection:
   - Note taken on [2025-07-20 Sun 10:11] \\
     This is radically out of date. So much so that it's an archeological artefact by
     now. So should I keep it?
